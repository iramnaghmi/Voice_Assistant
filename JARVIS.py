...
class MainThread(QThread):
    ...
    def SendEmail(self,to,content):
        print(content)
        server = smtplib.SMTP('iramnaghmi@gmail.com',Priyanka11)
        server.ehlo()
        server.starttls()
    ...
    #News
    def news(self):
        MAIN_URL_= "https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=8d8ae98fe7bf4b22bd107b354abc5f03"
